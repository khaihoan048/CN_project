...
class LoginWindow(Window):
    ...
    def build_window(self):
        ...
        self.label = tk.Label(self.root, text='Enter your username', width=20, font=self.font)
        ...
        self.label1 = tk.Label(self.root, text='Enter your password', width=20, font=self.font)
        self.label1.grid(row=1,column=0)

        self.entry1 = tk.Entry(self.root, width=20, font=self.font,show='*')
        self.entry1.grid(row=1,column=1)
        self.entry1.bind('<Return>', self.get_login_event)

        self.button = tk.Button(self.root, text='Login', font=self.font)
        self.button.grid(row=1,column=2)
        self.button.bind('<Button-1>', self.get_login_event)

        self.button1 = tk.Button(self.root, text='Register', font=self.font)
        self.button1.grid(row=2,column=2)
        # self.button.bind('<Button-1>', self.get_register_event)

        self.label2 = tk.Label(self.root, text='Don\'t have account? Register instead!', font=self.font)
...
class ChatWindow(Window):
    def __init__(self, gui, font):
        ...
        super().__init__("Python Chat:"+self.login, font)
    ...
    def build_window(self):
        ...
        self.messages_list.insert(tk.END, 'Test UI\n')
        ...
        self.send_button = tk.Button(frame03, text='Send file', font=self.font)
